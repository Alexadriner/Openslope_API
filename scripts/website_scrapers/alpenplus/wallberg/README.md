...
Scraper for Wallberg ski resort data from Alpenplus.com.
...
python -m scripts.website_scrapers.alpenplus.wallberg.collector --interval-seconds 86400

# Run without API sync
python -m scripts.website_scrapers.alpenplus.wallberg.collector --no-sync-api
```

## Configuration

- **Resort ID**: `wallberg`
- **Scraper Name**: `alpenplus_wallberg`
...
Data is saved to:
- Checkpoints: `checkpoints/website_scrapers/alpenplus_wallberg/`
- Logs: `logs/website_scrapers/alpenplus_wallberg/`