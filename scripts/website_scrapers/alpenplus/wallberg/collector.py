...
from scripts.website_scrapers.alpenplus.wallberg.scraper import WallbergScraper


ROOT_DIR = Path(__file__).resolve().parents[3]
OUT_DIR = ROOT_DIR / "checkpoints" / "website_scrapers" / "alpenplus_wallberg"
LOG_DIR = ROOT_DIR / "logs" / "website_scrapers" / "alpenplus_wallberg"
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Collect Wallberg website status snapshots every N seconds."
    )
    parser.add_argument("--resort-id", default="wallberg")
