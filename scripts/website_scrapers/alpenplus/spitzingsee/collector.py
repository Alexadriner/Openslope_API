...
from scripts.website_scrapers.alpenplus.spitzingsee.scraper import SpitzingseeScraper


ROOT_DIR = Path(__file__).resolve().parents[3]
OUT_DIR = ROOT_DIR / "checkpoints" / "website_scrapers" / "alpenplus_spitzingsee"
LOG_DIR = ROOT_DIR / "logs" / "website_scrapers" / "alpenplus_spitzingsee"
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Collect Spitzingsee website status snapshots every N seconds."
    )
    parser.add_argument("--resort-id", default="spitzingsee")
