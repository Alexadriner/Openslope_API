...
from scripts.website_scrapers.alpenplus.sudelfeld.scraper import SudelfeldScraper


ROOT_DIR = Path(__file__).resolve().parents[3]
OUT_DIR = ROOT_DIR / "checkpoints" / "website_scrapers" / "alpenplus_sudelfeld"
LOG_DIR = ROOT_DIR / "logs" / "website_scrapers" / "alpenplus_sudelfeld"
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Collect Sudelfeld website status snapshots every N seconds."
    )
    parser.add_argument("--resort-id", default="sudelfeld")
