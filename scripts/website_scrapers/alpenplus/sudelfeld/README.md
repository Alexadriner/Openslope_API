...
Scraper for Sudelfeld ski resort data from Alpenplus.com.
...
python -m scripts.website_scrapers.alpenplus.sudelfeld.collector --interval-seconds 86400

# Run without API sync
python -m scripts.website_scrapers.alpenplus.sudelfeld.collector --no-sync-api
```

## Configuration

- **Resort ID**: `sudelfeld`
- **Scraper Name**: `alpenplus_sudelfeld`
...
Data is saved to:
- Checkpoints: `checkpoints/website_scrapers/alpenplus_sudelfeld/`
- Logs: `logs/website_scrapers/alpenplus_sudelfeld/`