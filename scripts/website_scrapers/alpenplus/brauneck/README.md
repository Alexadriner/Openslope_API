...
Scraper for Brauneck-Wegscheid ski resort data from Alpenplus.com.
...
python -m scripts.website_scrapers.alpenplus.brauneck.collector --no-sync-api
```

## Configuration

- **Resort ID**: `brauneck`
- **Scraper Name**: `alpenplus_brauneck`
...
Data is saved to:
- Checkpoints: `checkpoints/website_scrapers/alpenplus_brauneck/`
- Logs: `logs/website_scrapers/alpenplus_brauneck/`