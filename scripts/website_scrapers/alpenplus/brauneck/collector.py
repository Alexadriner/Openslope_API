...
from scripts.website_scrapers.alpenplus.brauneck.scraper import BrauneckScraper


ROOT_DIR = Path(__file__).resolve().parents[3]
OUT_DIR = ROOT_DIR / "checkpoints" / "website_scrapers" / "alpenplus_brauneck"
LOG_DIR = ROOT_DIR / "logs" / "website_scrapers" / "alpenplus_brauneck"
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Collect Brauneck website status snapshots every N seconds."
    )
    parser.add_argument("--resort-id", default="brauneck")
