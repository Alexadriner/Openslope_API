...
GEOJSON_IMPORT_BASE = f"{API_BASE_URL}/import/geojson"
IMPORT_LIFTS_ENDPOINT = f"{GEOJSON_IMPORT_BASE}/lifts"
IMPORT_SLOPES_ENDPOINT = f"{GEOJSON_IMPORT_BASE}/slopes"
IMPORT_RESORTS_ENDPOINT = f"{GEOJSON_IMPORT_BASE}/resorts"
